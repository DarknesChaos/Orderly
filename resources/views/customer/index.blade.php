                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="btn-group pull-right">
                                    <a href="{{URL::route('customers.create')}}" class="btn green"><i class="fa fa-plus"></i> Nuevo Usuario</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                        ...
                        @foreach($customers as $customer)
                            <tr>
                                ...
                                <td>
                                    <a href="{{  URL::route('customers.edit', $customer->id) }}" title="Editar" class="btn btn-icon-only green-meadow ">
                                        <i class="fa fa-edit"></i>
                                    </a>

                                    <a href="{{  URL::route('customers.show', $customer->id) }}" title="Detalle" class="btn btn-icon-only blue ">
                                        <i class="fa fa-eye"></i>
                                    </a>

                                    <a href="#basic" data-toggle="modal" data-name="{{$customer->name}}" data-id="{{$customer->id}}" title="Eliminar" class="btn btn-icon-only red modalDelete">
